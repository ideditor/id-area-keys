...
function isArea(tags) {
  ...
  for (var key in tags) {
    if (key in areaKeys$1 && !(tags[key] in areaKeys$1[key])) return true;
  }

  return false;
}

exports.areaKeys = areaKeys$1;
